...
// validate fields
if(empty($title) || empty($type) || empty($address) || empty($description) || empty($owner_name) || empty($owner_email)) {
  echo "Todos os campos são obrigatórios - por favor tente novamente.";
  exit;
